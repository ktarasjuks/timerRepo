...
class CountDown:
    def __init__(self, root):
        ...
        self.img = PhotoImage(file="harley.png")
        #
        #
        # # self.window.configure(bg="gray35")
        picture_label =Label(self.window, image=self.img)
        ...
        width=0, height=0).place(x=100, y=210)
        ...
        pause_button.place(x=300, y=150)
...
if __name__ == "__main__":
    ...
    # root.wm_attributes("-transparentcolor", 'gray35')
    # canvas = Canvas(root, bg="black", width=700, height=400)
    # canvas.pack()
    #
    # background = PhotoImage(file="featured.png")
